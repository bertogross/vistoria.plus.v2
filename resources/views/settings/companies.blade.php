...
@section('content')
    ...
    <p>Otimize a distribuição de tarefas incorporando Unidades ao seu {{ appName() }}</p>
    ...
    <div class="card">
        <div class="card-body">
            <p class="text-muted small">Unidades desativadas deixarão de ser exibidas em seus dashboards</p>
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="2" class="align-top">
                                    <button type="button" class="btn btn-sm btn-label left btn-outline-theme float-start" id="btn-add-company-row" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Adicionar Unidade">
                                        <i class="ri-add-line label-icon align-middle fs-16 me-2"></i>Unidade
                                    </button>
                                </td>
                                <td>
                                    <button type="submit" class="btn btn-label right btn-outline-theme float-end" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="left" title="Atualizar Listagem de Unidades">
