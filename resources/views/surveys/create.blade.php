                            ...
                            @else
                                <div>
                                    ...
                                    @if ($getActiveCompanies && count($getActiveCompanies) > 1)
                                        <div class="form-text mt-0 mb-3">Selecione quem irá desempenhar esta tarefa. 1 colaborador(a) por Empresa</div>
                                    @else
                                                                ...
                                                                @if ( is_array($userCompanies) && in_array($company->id, $userCompanies) && in_array($userRole, [1, 3]) )
                                                                    <li>
                                                                        <div class="form-check form-check-success d-flex align-items-center">
                                                                            <input class="form-check-input form-check-input-users me-3 wizard-switch-control" type="radio" name="surveyor[{{$company->id}}]"
                                                                                value="{{ $userId }}" id="surveyor-user-{{ $company->id.$userId }}" {{ $isDelegated ? 'checked' : '' }}>
