...
(function () {
	...
	function pluginData() {
		...
		// Dropdown
        if(document.querySelectorAll('.dropdown-menu a[data-bs-toggle="tab"]').length){
	...
	function twoColumnMenuGenerate() {
		...
		if (defaultValues && (isTwoColumn == "twocolumn" || defaultValues["data-layout"] == "twocolumn")) {
			...
			if (currentPath) {
				// navbar-nav
                if(document.getElementById("navbar-nav") && document.getElementById("navbar-nav").querySelector('[href="' + currentPath + '"]')){
	...
	function setResize() {
		...
		if (currentLayout !== "horizontal") {
			...
			if (document.getElementsByClassName("twocolumn-iconview")) {
				var simpleBar1 = new SimpleBar(
					document.getElementsByClassName("twocolumn-iconview")[0]
				);
				if (simpleBar1) simpleBar1.getContentElement();
