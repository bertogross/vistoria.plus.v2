...
<div class="<?php echo e($classCols); ?> mb-3">
    <div id="barTermsChart<?php echo e($companyId); ?>" class="card p-3 h-100"></div>
</div>

<div class="<?php echo e($classCols); ?> mb-3">
    <div id="mixedTermsChart<?php echo e($companyId); ?>" class="card p-3 h-100"></div>
</div>

<div class="<?php echo e($classCols); ?> mb-3">
    <div id="polarTermsAreaChart<?php echo e($companyId); ?>" class="card p-3 h-100"></div>
</div>

<script>
    const rawTermsData<?php echo e($companyId); ?> = <?php echo json_encode($analyticTermsData, 15, 512) ?>;
    const terms<?php echo e($companyId); ?> = <?php echo json_encode($terms, 15, 512) ?>;
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        for (var termId in rawTermsData<?php echo e($companyId); ?>) {
            var termData = rawTermsData<?php echo e($companyId); ?>[termId];
            ...
            seriesData.push({
                x: terms<?php echo e($companyId); ?>[termId] && terms<?php echo e($companyId); ?>[termId]['name'] ? terms<?php echo e($companyId); ?>[termId]['name'] : "Term " + termId,
                y: complianceScore
            });

            categories.push(terms<?php echo e($companyId); ?>[termId] && terms<?php echo e($companyId); ?>[termId]['name'] ? terms<?php echo e($companyId); ?>[termId]['name'] : "Term " + termId);
        }
        ...
        var barTermsChart = new ApexCharts(document.querySelector("#barTermsChart<?php echo e($companyId); ?>"), optionsTermsChart);
        ...
        for (var termId in rawTermsData<?php echo e($companyId); ?>) {
            ...
            categories.push(terms<?php echo e($companyId); ?>[termId]['name']);
        }
        ...
        var mixedTermsChart = new ApexCharts(document.querySelector("#mixedTermsChart<?php echo e($companyId); ?>"), optionsMixedTermsChart);
        ...
        for (var termId in rawTermsData<?php echo e($companyId); ?>) {
            ...
            labels.push(terms<?php echo e($companyId); ?>[termId] && terms<?php echo e($companyId); ?>[termId]['name'] ? terms<?php echo e($companyId); ?>[termId]['name'] : "Term " + termId);
        }
        ...
        for (var termId in termMetrics) {
            ...
            if (terms<?php echo e($companyId); ?>[termId] && terms<?php echo e($companyId); ?>[termId]['name']) {
                labels.push(terms<?php echo e($companyId); ?>[termId]['name']);
            } else {
        ...
        var polarTermsAreaChart = new ApexCharts(document.querySelector("#polarTermsAreaChart<?php echo e($companyId); ?>"), optionsTermsAreaChart);
...
<?php /**PATH D:\www\vistoria.plus\application\development2.vistoria.plus\public_html\resources\views/surveys/layouts/chart-terms.blade.php ENDPATH**/ ?>