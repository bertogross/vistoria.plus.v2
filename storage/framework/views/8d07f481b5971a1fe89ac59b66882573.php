...
<?php $__env->startSection('content'); ?>
    ...
    <?php if( $profileUserId == auth()->id() || in_array($profileUserId, $getGuestIdsConnectedOnHost) ): ?>
            ...
            <div class="row g-4">
                <div class="col-auto">
                    <div class="avatar-lg profile-user position-relative d-inline-block">
                        <img src="<?php echo e(checkUserAvatar($user->avatar)); ?>" alt="avatar" class="img-thumbnail rounded-circle avatar-img" loading="lazy" />
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/development.vistoria.plus/public_html/resources/views/profile/index.blade.php ENDPATH**/ ?>