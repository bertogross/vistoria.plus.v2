                                        ...
                                        <?php $__currentLoopData = $surveyAssignmentData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr class="main-row" data-id="<?php echo e($assignmentId); ?>">
                                                ...
                                                <td scope="row" class="text-end">
                                                    <a class="btn btn-sm btn-outline-dark ri-eye-line <?php echo e($surveyorStatus == 'new' ? 'cursor-not-allowed' : 'btn-assignment-view-form'); ?>"
                                                    <?php if($surveyorStatus == 'new'): ?>
                                                        onclick="alert('Tarefa ainda não foi inicializada e por isso não há dados disponíveis');"
                                                    <?php else: ?>
                                                        href="<?php echo e(route('assignmentShowURL', $assignmentId)); ?>"
                                                    <?php endif; ?>
                                                    data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="<?php echo e($surveyorStatus == 'new' ? 'Tarefa ainda não foi inicializada e por isso não há dados disponíveis' : 'Visualizar'); ?>" data-assignment-id="<?php echo e($assignmentId); ?>" data-assignment-title="<?php echo e(limitChars($title ?? '', 30)); ?>"></a>
                                                </td>
                                            </tr>
...
<?php /**PATH /var/www/html/development.vistoria.plus/public_html/resources/views/surveys/layouts/modal-listing-assignments.blade.php ENDPATH**/ ?>