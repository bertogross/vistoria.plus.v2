                    ...
                    <div class="col-sm-12 col-md-auto mb-4">
                        <div class="p-3 bg-light-subtle rounded position-relative">
                            <button type="button"
                                ...
                                <?php endif; ?>
                                class="btn btn-<?php echo e(!$swapData ? 'soft-' : ''); ?>theme waves-effect"
                            ...
                            <button class="btn btn-soft-theme waves-effect ms-2 <?php echo e($swapData ? '' : 'btn-print-this'); ?>"
                                <?php if($swapData): ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\www\vistoria.plus\application\development2.vistoria.plus\public_html\resources\views/surveys/show.blade.php ENDPATH**/ ?>