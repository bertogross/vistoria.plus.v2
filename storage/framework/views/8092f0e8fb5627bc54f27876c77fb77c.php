                        ...
                        <div class="col-auto text-end">
                            <?php if($currentUserId == $designatedUserId && in_array($statusKey, ['new','pending','in_progress']) ): ?>
                                <button type="button"
                                    ...
                                    class="btn btn-sm btn-label right waves-effect btn-<?php echo e($status['color']); ?> <?php echo e($designated == 'surveyor' ? 'btn-assignment-surveyor-action' : 'btn-assignment-auditor-action'); ?>"
...
<?php /**PATH D:\www\vistoria.plus\application\development2.vistoria.plus\public_html\resources\views/surveys/layouts/profile-task-card.blade.php ENDPATH**/ ?>