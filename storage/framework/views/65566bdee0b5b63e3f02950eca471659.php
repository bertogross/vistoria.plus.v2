...
<?php if($customerId): ?>
    ...
    <?php endif; ?>
<?php else: ?>
    Não foi possível carregar os dados de faturamento na Stripe.<br>Certifique-se se já é assinante do <?php echo e(appName()); ?>.

    <br><br>

    <a href="<?php echo e(route('settingsAccountShowURL')); ?>/?tab=subscription" class="btn btn-theme" title="Clique para visualizar o plano de assinatura do <?php echo e(appName()); ?>">Assinar o <?php echo e(appName()); ?></a>
<?php endif; ?>
<?php /**PATH /var/www/html/development.vistoria.plus/public_html/resources/views/settings/stripe/invoices.blade.php ENDPATH**/ ?>