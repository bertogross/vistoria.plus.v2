...
class SettingsAccountController extends Controller
{
    ...
    public function show()
    {
        ...
        $getSsubscriptionData = getSsubscriptionData();
        $getSsubscriptionData = $getSsubscriptionData ? json_decode($getSsubscriptionData, true) : null;
        $customerId = isset($getSsubscriptionData['customer_id']) ? $getSsubscriptionData['customer_id'] : '';
        $subscriptionId = isset($getSsubscriptionData['subscription_id']) ? $getSsubscriptionData['subscription_id'] : '';
